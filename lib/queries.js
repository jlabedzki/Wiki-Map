...
const listAllMaps = (userID) => {
  return db
    .query(`
      ...
      WHERE maps.id != ALL (SELECT maps.id
        FROM maps
        JOIN favorites
        ON maps.id = map_id
        JOIN users
...
module.exports = { listAllMaps, listMap, listAllFavorites, listMyMaps, listMyContributions, addMapToFavorites, removeMapFromFavorites, addMap, addPin, loadPins, editPin, deletePin };
